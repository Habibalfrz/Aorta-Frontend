    ...
    <aside class="hidden lg:flex w-72 bg-card/60 backdrop-blur-2xl border-r border-border/60 flex-col flex-shrink-0 z-20 relative">
      ...
      <div class="p-4 shrink-0 border-t border-border/60">
        <button
          ...
          class="w-full flex items-center justify-center px-3 py-2 mb-2 rounded-xl border border-border/60 bg-card/80 text-xs font-semibold text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors shadow-sm"
        >
          <ArrowLeft class="w-3 h-3 mr-2" /> Back to SysAdmin
        </button>

        <button
          @click="router.push('/ess')"
        ...
        >
          <ArrowLeft class="w-3 h-3 mr-2" /> Back to ESS Portal
        </button>
        ...
        <Sheet v-model:open="isMobileOpen">
          ...
          <SheetContent side="left" class="w-[85vw] max-w-[280px] p-0 flex flex-col border-r border-border bg-card/95 backdrop-blur-2xl">
            ...
            <div class="p-4 shrink-0 border-t border-border">
              <button
                @click="router.push('/ess')"
                class="w-full flex items-center justify-center px-3 py-2.5 mb-2 rounded-xl border border-border/60 bg-card/80 text-xs font-semibold text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors shadow-sm"
              >
                <ArrowLeft class="w-3 h-3 mr-2" /> Back to ESS Portal
              </button>
